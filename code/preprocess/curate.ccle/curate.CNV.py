...
cellline_path = os.path.join(proj_path, 'data/curated/Lung/ccle/ccle.lung.cellline.meta.csv')
out_path = os.path.join(proj_path, 'data/curated/Lung/ccle/ccle.lung_CNV_allgene.csv')

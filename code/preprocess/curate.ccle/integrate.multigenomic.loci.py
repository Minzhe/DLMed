...
mut_path = os.path.join(proj_path, 'data/curated/lung/loci.level/lung_MutExpr_cancergene_loci.csv')
expr_path = os.path.join(proj_path, 'data/curated/lung/gene.level/lung_RNAseq_cancergene.csv')
cnv_path = os.path.join(proj_path, 'data/curated/lung/gene.level/lung_CNV_cancergene.csv')
drug_path = os.path.join(proj_path, 'data/curated/lung/ccle.lung.gdsc.csv')
out_path = os.path.join(proj_path, 'data/curated/lung/loci.level/lung_MutExprCNV_cancergene_drug_loci.pkl')

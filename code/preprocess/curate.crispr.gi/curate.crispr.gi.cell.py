...
##############################    phenotype score    #############################
# proj_path = '/work/bioinformatics/s418336/projects/DLMed'
# pheno_path = os.path.join(proj_path, 'data/CRISPR.GI/crispr.GI.cell.phenotype.txt')
...
##############################    gi score    #############################
gi_path = os.path.join(proj_path, 'data/CRISPR.GI/crispr.GI.cell.GI_score.K562.csv')
dense_out_path = os.path.join(proj_path, 'data/curated/K562/crispr.doubleKO.cell.geno.giscore.dense.csv')
sparse_out_path = os.path.join(proj_path, 'data/curated/K562/crispr.doubleKO.cell.geno.giscore.sparse.csv')

# read table
gi = pd.read_csv(gi_path, skiprows=4, header=None, names=['Gene1', 'Gene2', 'K562_rep1_gi', 'K562_rep1_corr', 'K562_rep2_gi', 'K562_rep2_corr', 'K562_ave_gi', 'K562_ave_corr', \
                                                                            'Jurkat_rep1_gi', 'Jurkat_rep1_corr', 'Jurkat_rep2_gi', 'Jurkat_rep2_corr', 'Jurkat_ave_gi', 'Jurkat_ave_corr'])

# dense table
gi = gi[['Gene1', 'Gene2', 'K562_ave_gi']]
gi.columns = ['Gene1', 'Gene2', 'gi_score']
gi = gi.loc[gi.gi_score.notnull(),:]
gi = gi.loc[gi.Gene1 != gi.Gene2,:]
gi.to_csv(dense_out_path, index=None)

...
if __name__ == '__main__':
    ...
    model_path = os.path.join(proj_path, 'code/predict/model_repo/rfr/RFR.ccle_utsw.cell.MutExpr')
    out_path = os.path.join(proj_path, 'result/genomic.drugsens/ccle_utsw.cell.MutExpr.rfr.r2_corr.csv')
    ...
    result = pd.DataFrame(list(return_dict.values()), columns=['n_estimators', 'max_features', 'criterion', 'max_depth', 'r2_train', 'r2_val', 'r2_inference'])

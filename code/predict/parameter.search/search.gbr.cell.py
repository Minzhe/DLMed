...
if __name__ == '__main__':
    ...
    model_path = os.path.join(proj_path, 'code/predict/model/gbr/GBR.ccle_utsw.cell.MutExprCNV')
    out_path = os.path.join(proj_path, 'result/genomic.drugsens/ccle_utsw.cell.MutExprCNV.gbr.result.csv')
    ...
    result = pd.DataFrame(list(return_dict.values()), columns=['loss', 'learning_rate', 'n_estimators', 'max_features', 'subsample', 'r2_train', 'r2_val', 'r2_test'])
